...
image::import-non-kicad-filter.png[align=center, width=80%, alt="Altium PcbDoc selector shown in file open explorer", link=import-non-kicad-filter.png]
...
image::import-non-kicad-pcbdoc-complete.png[align=center, width=80%, alt="Altium PcbDoc selector shown in file open explorer", link=import-non-kicad-pcbdoc-complete.png]
