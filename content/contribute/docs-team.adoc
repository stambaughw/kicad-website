...
Most of the action takes place on two repositories on GitLab.
 ...
 - link:https://gitlab.com/KiCad/services/kicad-doc[Official Documentation]
...
Simply fork the repositories linked above on GitLab and submit a merge
...
link:https://gitlab.com/KiCad/services/kicad-doc/-/blob/master/src/gui_translation_howto/gui_translation_howto.adoc[KiCad GUI Translation HOWTO].
