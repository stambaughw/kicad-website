...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<div id="mirrors-64bit" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="mirrors-64bit-heading">
			<div class="panel-body">
				<div class="list-group download-list-group">
					<a class="list-group-item" href="https://kicad-downloads.s3.cern.ch/windows/stable/kicad-5.1.8_1-x86_64.exe">
						<img src="/img/about/cern-logo.png" /> CERN - Switzerland
					</a>
					<a class="list-group-item" href="https://www2.futureware.at/~nickoe/kicad-downloads-mirror/windows/stable/kicad-5.1.8_1-x86_64.exe">
						Futureware - Austria
					</a>
					<a class="list-group-item" href="https://osdn.net/projects/kicad/storage/kicad-5.1.8_1-x86_64.exe">
	...
	<div class="panel panel-default">
		...
		<div id="mirrors-32bit" class="panel-collapse collapse" role="tabpanel" aria-labelledby="mirrors-32bit-heading">
			<div class="panel-body">
				<div class="list-group download-list-group">
					<a class="list-group-item" href="https://kicad-downloads.s3.cern.ch/windows/stable/kicad-5.1.8_1-i686.exe">
						<img src="/img/about/cern-logo.png" /> CERN - Switzerland
					</a>
					<a class="list-group-item" href="https://www2.futureware.at/~nickoe/kicad-downloads-mirror/windows/stable/kicad-5.1.8_1-i686.exe">
						Futureware - Austria
					</a>
					<a class="list-group-item" href="https://osdn.net/projects/kicad/storage/kicad-5.1.8_1-i686.exe">
						<img src="/img/download/osdn.png" /> OSDN - Asia + North America
					</a>
				</div>
			</div>
